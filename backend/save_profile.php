...
try {
    ...
    $stmt = $pdo->prepare("
        ...
        (user_id, age, gender, height, weight, activity_level, fitness_goal, target_weight, target_date, diet_preference, allergies, medical_conditions, survey_step) 
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    ...
    $stmt->execute([
        ...
        $target_weight, $target_date, $diet_preference, $allergies, $medical_conditions, $survey_step
    ]);
